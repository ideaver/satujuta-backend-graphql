...
export class TransactionService {
  ...
  async createOne(transactionCreateArgs: CreateOneTransactionArgs): Promise<Transaction | void> {
  ...
  async findOne(transactionFindUniqueArgs: TransactionFindUniqueArgs): Promise<Transaction | void> {
    return await this.prisma.transaction
  ...
  async update(transactionUpdateOneArgs: TransactionUpdateOneArgs): Promise<Transaction | void> {
    return this.prisma.transaction
