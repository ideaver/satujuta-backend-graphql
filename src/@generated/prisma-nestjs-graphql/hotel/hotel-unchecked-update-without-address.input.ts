...
import { CheckInUncheckedUpdateManyWithoutHotelNestedInput } from '../check-in/check-in-unchecked-update-many-without-hotel-nested.input';
...
export class HotelUncheckedUpdateWithoutAddressInput {
    ...
    checkIns?: CheckInUncheckedUpdateManyWithoutHotelNestedInput;
}
